...
var createDealFinalReturn = function(sessionData){
  ...
  if (typeof(bestQuote) !== 'undefined'){
    ...
    var destinationCity = sessionData.destinationCity
    ...
    var picture_url = countryPictures[cityFR].pictureUrl
    var author_name = countryPictures[cityFR].authorName
    var author_link = countryPictures[cityFR].authorLink
    ...
    deal.destinationCity = destinationCity
